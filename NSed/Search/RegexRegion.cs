...
namespace NSed.Search.Region
{
    public class RegexRegion : SearchRegion
    {
        public RegexRegion(String[] lines, int? startLineOffset, int? endLineOffset,
            string startLineRegexStr, string endLineRegexStr, bool useLastLine, bool caseSensitive)
            : base(lines, new StartRegexIndex(startLineOffset, startLineRegexStr, useLastLine, caseSensitive),
            new EndRegexIndex(endLineOffset, endLineRegexStr, useLastLine, caseSensitive))
        {
        }
    }
}
